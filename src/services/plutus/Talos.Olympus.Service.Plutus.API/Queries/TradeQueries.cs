...
using Talos.Olympus.Service.Plutus.Application.Queries.Trades.GetMarketTrades;
using Talos.Olympus.Service.Plutus.Application.Queries.Trades.GetSymbolTrades;
