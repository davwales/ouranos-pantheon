...
import { SymbolTable } from "@/app/(plutus)/plutus/[marketId]/recipes/_components/symbol-table";
import { SelectedSymbol } from "@/app/(plutus)/plutus/components/symbol-search";
