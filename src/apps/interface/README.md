...
The intent of this module is to provide the user interface for the various Pantheon modules. At time of writing this includes Hermes to have conversations with various user-created assistants and Plutus which allows users to explore market data to find potential investments.
