...
namespace Ouranos.Pantheon.Modules.Hermes.Migrations
{
    ...
    [Migration("20260526151822_AddFolders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConversationTrait", b =>
                {
            ...
            modelBuilder.Entity("Ouranos.Pantheon.Modules.Hermes.Shared.Domain.AvailableModels.AvailableModel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_available_models");

                    b.HasIndex("ModelIdentifier")
                        .IsUnique()
                        .HasDatabaseName("ix_available_models_model_identifier");

                    b.ToTable("available_models", "hermes");
                });
            ...
            modelBuilder.Entity("Ouranos.Pantheon.Modules.Hermes.Shared.Domain.Conversations.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ouranos.Pantheon.Modules.Hermes.Shared.Domain.Personas.Persona", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ouranos.Pantheon.Modules.Hermes.Shared.Domain.Traits.Trait", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
