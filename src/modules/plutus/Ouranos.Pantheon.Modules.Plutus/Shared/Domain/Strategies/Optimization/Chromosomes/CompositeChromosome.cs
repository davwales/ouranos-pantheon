...
public sealed class CompositeChromosome(TradingConfiguration configuration) : StrategyChromosome(configuration)
{
    ...
    public override IChromosome<double> Crossover(IChromosome<double> other)
    {
        ...
        {
            throw new InvalidOperationException($"Crossover partner must be a {nameof(CompositeChromosome)}.");
        }
