...
public sealed class ClosePositionHandler
    : IPantheonHandler<ClosePositionInput, ClosePositionResponse>
{
    private readonly PlutusDbContext _dbContext;
    private readonly ILogger<ClosePositionHandler> _logger;

    public ClosePositionHandler(ILogger<ClosePositionHandler> logger, PlutusDbContext dbContext)
    {
