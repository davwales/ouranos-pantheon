...
public sealed class LinkPositionHandler : IPantheonHandler<LinkPositionInput, IdResponse<Position>>
{
    private readonly PlutusDbContext _dbContext;
    private readonly ILogger<LinkPositionHandler> _logger;

    public LinkPositionHandler(ILogger<LinkPositionHandler> logger, PlutusDbContext dbContext)
    {
    ...
    )
    {
        ...
        var targetPosition = await _dbContext
