...
public partial class ConvertStrategyAndBacktestToRelationalTables : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                configuration_buy_threshold = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                configuration_sell_threshold = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                configuration_forecast_movement_threshold = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                configuration_forecast_horizon_days = table.Column<int>(
                    type: "integer",
                    nullable: true
                ),
                configuration_deviation_multiplier = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                configuration_mean_time_frame_value = table.Column<int>(
                    type: "integer",
                    nullable: true
                ),
                configuration_min_margin_percent = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ...
                configuration_max_position_percent = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                end_date = table.Column<DateTimeOffset>(
                    type: "timestamp with time zone",
                    nullable: false
                ),
                budget = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: false
                ...
                results_total_return = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                results_total_return_percent = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                results_max_drawdown = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                results_max_drawdown_percent = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                results_win_rate = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ...
                results_sharpe_ratio = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                results_average_trade_return = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                results_best_trade = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                results_worst_trade = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
                ),
                results_final_balance = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: true
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                entry_price = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: false
                ),
                exit_price = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: false
                ...
                profit_loss = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: false
                ),
                return_percent = table.Column<decimal>(
                    type: "numeric(18,2)",
                    precision: 18,
                    scale: 2,
                    nullable: false
                ),
                entry_time = table.Column<DateTimeOffset>(
                    type: "timestamp with time zone",
                    nullable: false
                ),
                exit_time = table.Column<DateTimeOffset>(
                    type: "timestamp with time zone",
                    nullable: false
                ),
            },
    ...
    {
        migrationBuilder.DropTable(name: "backtest_position", schema: "plutus");
        ...
        migrationBuilder.DropTable(name: "backtests", schema: "plutus");

        migrationBuilder.DropTable(name: "strategies", schema: "plutus");
    }
}
