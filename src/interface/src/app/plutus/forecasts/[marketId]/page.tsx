...
import { GetMarketForecastResponseFilterInput, SortEnumType } from "@/gql/graphql";
...
export default function RecentMarketTrades() {
    ...
    const [filter, setFilter] = useState<GetMarketForecastResponseFilterInput>({});
    const [sort, setSort] = useState<SortArgs>({ dayOne: { gain: SortEnumType.Desc } });
