...
export type ForecastFilterInput = {
  ...
  symbol?: InputMaybe<SymbolFilterInput>;
...
export type ForecastSortInput = {
  ...
  symbol?: InputMaybe<SymbolSortInput>;
...
export type ListFilterInputTypeOfSymbolFilterInput = {
  all?: InputMaybe<SymbolFilterInput>;
  any?: InputMaybe<Scalars['Boolean']['input']>;
  none?: InputMaybe<SymbolFilterInput>;
  some?: InputMaybe<SymbolFilterInput>;
};
...
export type RecipeFilterInput = {
  ...
  market?: InputMaybe<MarketFilterInput>;
  marketId?: InputMaybe<IdFilterInputTypeOfMarketFilterInput>;
  name?: InputMaybe<StringOperationFilterInput>;
...
export type RecipeSortInput = {
  ...
  createdAt?: InputMaybe<SortEnumType>;
  id?: InputMaybe<SortEnumType>;
  market?: InputMaybe<MarketSortInput>;
  marketId?: InputMaybe<SortEnumType>;
  name?: InputMaybe<SortEnumType>;
  updatedAt?: InputMaybe<SortEnumType>;
};
...
export type SymbolGroupFilterInput = {
  ...
  symbols?: InputMaybe<ListFilterInputTypeOfSymbolFilterInput>;
  updatedAt?: InputMaybe<DateTimeOperationFilterInput>;
};
...
export type DeleteRecipeMutation = { __typename?: 'Mutation', deleteRecipe: { __typename?: 'DeleteRecipePayload', idResponseOfRecipe?: { __typename?: 'IdResponseOfRecipe', id: string } | null } };
...
export type CreateRecipeMutation = { __typename?: 'Mutation', createRecipe: { __typename?: 'CreateRecipePayload', idResponseOfRecipe?: { __typename?: 'IdResponseOfRecipe', id: string } | null } };
...
export type GetMarketTradesQuery = { __typename?: 'Query', marketTrades?: { __typename?: 'MarketTradesConnection', totalCount: number, nodes?: Array<{ __typename?: 'GetMarketTradesResponse', averagePrice: any, limit: any, margin: any, maxPrice: any, minPrice: any, numTransactions: number, roi: any, totalGain: any, totalSpent: any, totalVolume: any, symbol: { __typename?: 'Symbol', id: string, name: string, code: string, subcode?: string | null } }> | null, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } | null };
...
export type GetRecentMarketTradesQuery = { __typename?: 'Query', allTrades?: { __typename?: 'AllTradesConnection', nodes?: Array<{ __typename?: 'Trade', createdAt: any, price: any, volume: any, symbol: { __typename?: 'Symbol', id: string, name: string, subcode?: string | null } }> | null } | null };
...
export const SearchSymbolsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SearchSymbols"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"marketId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"query"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"allSymbols"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"name"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"contains"},"value":{"kind":"Variable","name":{"kind":"Name","value":"query"}}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"marketId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"marketId"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"subcode"}}]}}]}}]}}]} as unknown as DocumentNode<SearchSymbolsQuery, SearchSymbolsQueryVariables>;