...
namespace Ouranos.Pantheon.Modules.Shared.Tests.API.FieldHandlers;
...
public sealed class QueryableStringInvariantHandlerTests
{
    ...
    public void CanHandle_WhenSupportedType_ShouldReturnTrue(int operationId)
    {
        ...
        var fieldDefinition = new FilterOperationFieldDefinition { Id = operationId };
    ...
    public void CanHandle_WhenUnsupportedType_ShouldReturnFalse()
    {
        ...
        var context = Substitute.For<ITypeCompletionContext>();
        var typeDefinition = Substitute.For<IFilterInputTypeDefinition>();
        var fieldDefinition = new FilterOperationFieldDefinition { Id = DefaultFilterOperations.Equals };
    ...
    public void CanHandle_WhenUnsupportedFilterOperation_ShouldReturnFalse()
    {
        ...
        var context = Substitute.For<ITypeCompletionContext>();
        var typeDefinition = Substitute.For<IFilterInputTypeDefinition>();
        var fieldDefinition = new FilterOperationFieldDefinition { Id = DefaultFilterOperations.GreaterThan };
    ...
    )
    {
        ...
        // Assert
        actualExpression.ShouldBeEquivalentTo(
            Expression.Call(
